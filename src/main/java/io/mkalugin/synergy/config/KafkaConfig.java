...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, MessageDto> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "io.mkalugin.synergy.dto");
        configProps.put(JsonDeserializer.TYPE_MAPPINGS, "messageDto:io.mkalugin.synergy.dto.MessageDto");
